...
df_part = pd.DataFrame(
    [[75930],[75930],[18088],[0],[8012],[8538],[2802],[0],[46325],[40840],[19313],[9638],[0],[600]],
...
st.subheader('3. 食費内訳')
df_part = pd.DataFrame(
    [[5599],[3911],[3732],[3261],[3020],[1495],[6552],[3928],[9063],[5325.8],[3339],[11905],[1543],[3153.2],[4400], [7370],[7000],[9350],[2077],[1141]],
